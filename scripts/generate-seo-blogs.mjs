...
<main id="conteudo"><header class="container page-hero reveal"><span class="eyebrow">${esc(post.category)}</span><h1>${esc(post.title)}</h1><p class="article-meta">Agência doco · 19 de junho de 2026 · ${estimatedMinutes} minutos</p></header><figure class="container article-cover reveal"><img src="../assets/blog/${post.slug}/imagem-principal.jpg" alt="Foto relacionada a ${esc(post.keyword)}" width="1400" height="788"><figcaption>Foto: Unsplash</figcaption></figure><div class="container article-layout"><article class="article-body reveal">${content}</article><aside class="article-aside glass reveal"><span class="eyebrow">Diagnóstico gratuito</span><h3>Descubra onde sua jornada perde oportunidades.</h3><p>Responda ao quiz e identifique qual etapa merece atenção primeiro.</p><a class="button small" href="https://quiz.agenciadoco.com.br/">Diagnosticar meu funil ↗</a></aside></div></main>
...
const cards = posts.map((post) => `<article class="blog-card glass reveal"><time datetime="${today}">${esc(post.category)} · leitura aprofundada</time><a class="arrow-link" href="blog/${post.slug}.html" aria-label="Ler ${esc(post.title)}">↗</a><img class="blog-card-image" src="assets/blog/${post.slug}/imagem-principal.jpg" alt="Foto sobre ${esc(post.keyword)}" width="1400" height="788" loading="lazy"><h3>${esc(post.title)}</h3><p>${esc(post.summary)}</p></article>`).join("\n      ");
